...
;    for date=0, 3 do begin
     ...
     ; save outputs
    fname='\\file-wron\Working\work\Juan_Pablo\Open_Water_mapping\MOD09A1.005.AUST.OWL\temporal_metrics\OWL_GT_01.img'
    ENVI_WRITE_ENVI_FILE, OWL_GT_01, OUT_NAME=fname, MAP_INFO=MAP_INFO

    fname='\\file-wron\Working\work\Juan_Pablo\Open_Water_mapping\MOD09A1.005.AUST.OWL\temporal_metrics\OWL_GT_10.img'
    ENVI_WRITE_ENVI_FILE, OWL_GT_10, OUT_NAME=fname, MAP_INFO=MAP_INFO

    fname='\\file-wron\Working\work\Juan_Pablo\Open_Water_mapping\MOD09A1.005.AUST.OWL\temporal_metrics\OWL_GT_30.img'
    ENVI_WRITE_ENVI_FILE, OWL_GT_30, OUT_NAME=fname, MAP_INFO=MAP_INFO

    fname='\\file-wron\Working\work\Juan_Pablo\Open_Water_mapping\MOD09A1.005.AUST.OWL\temporal_metrics\OWL_GT_50.img'
    ENVI_WRITE_ENVI_FILE, OWL_GT_50, OUT_NAME=fname, MAP_INFO=MAP_INFO

    fname='\\file-wron\Working\work\Juan_Pablo\Open_Water_mapping\MOD09A1.005.AUST.OWL\temporal_metrics\OWL_GT_70.img'
    ENVI_WRITE_ENVI_FILE, OWL_GT_70, OUT_NAME=fname, MAP_INFO=MAP_INFO

    fname='\\file-wron\Working\work\Juan_Pablo\Open_Water_mapping\MOD09A1.005.AUST.OWL\temporal_metrics\OWL_GT_90.img'
    ENVI_WRITE_ENVI_FILE, OWL_GT_90, OUT_NAME=fname, MAP_INFO=MAP_INFO

    fname='\\file-wron\Working\work\Juan_Pablo\Open_Water_mapping\MOD09A1.005.AUST.OWL\temporal_metrics\OWL_EQ_255.img'
