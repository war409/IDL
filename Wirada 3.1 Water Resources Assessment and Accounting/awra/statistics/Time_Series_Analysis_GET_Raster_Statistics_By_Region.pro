; ##########################################################################
; NAME: Time_Series_Analysis_GET_Raster_Statistics_By_Region.pro
; LANGUAGE: ENVI + IDL
...
; ##########################################################################
;
PRO Time_Series_Analysis_GET_Raster_Statistics_By_Region
  ;-------------------------------------------------------------------------
  ; GET START TIME
  T_TIME = SYSTIME(1)
  PRINT,''
  PRINT,'BEGIN PROCESSING: Time_Series_Analysis_GET_Raster_Statistics_By_Region'
  PRINT,''
  ;-------------------------------------------------------------------------
  ;*************************************************************************
  ; INPUT/OUTPUT: 
  ...
  IN_PREFIX = 'MODIS.FractCover.mean.8day.composite'
  ;-------------------------------------------------------------------------
  ; SELECT THE INPUT DATA
  ...
  YYYYDOY = STRMID(FNAME_SHORT, 11, 7)
  YYYY = STRMID(FNAME_SHORT, 11, 4)
  DOY = STRMID(FNAME_SHORT, 16, 3)
  ...
  PRINT,''
  PRINT,'FINISHED PROCESSING: Time_Series_Analysis_GET_Raster_Statistics_By_Region'
  PRINT,''
  ;-------------------------------------------------------------------------
END  