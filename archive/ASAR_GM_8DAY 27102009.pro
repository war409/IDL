...
PRO ASAR_GM_8DAY
  ...
  ;
  ; SETUP DATE LOOP
  SA = JULDAY(5, 9, 2005) ; (M,D,YYYY)
  DA = 8
  EA = JULDAY(1, 5, 2006) ; (M,D,YYYY)
  VA = SA
  ;
  ; DATE LOOP
  WHILE (VA = VA + DA) LE EA DO BEGIN
    ...
    ENDIF ELSE BEGIN
      ...
      IF COUNT LE 15 THEN BEGIN
        ;---------------------------------------------------------------------------------
        ; WRITE NEW EMPTY OUTPUT FILE
        PRINT, '  WRITE NEW EMPTY OUTPUT FILE'
        ; SET THE OUTPUT FILE PATH AND NAME
        ; OUTPUT PATH
        OUTPATH = 'R:/ASAR_GM/ENVI_daily/Australia_BINARY_8DAY/2005/'
        ; OUTPUT NAME PART 1
        ...
        OUTFILE = FILEPATH(OUTNAME, ROOT_DIR='R:\', SUBDIRECTORY='ASAR_GM\ENVI_daily\Australia_BINARY_8DAY\2005')
      ...
      ENDIF ELSE BEGIN
        ...
        FOR l=0, UNIQC-1 DO BEGIN
            ...
            ; SET THE OUTPUT FILE PATH AND NAME
            ; OUTPUT PATH
            OUTPATH = 'R:/ASAR_GM/ENVI_daily/Australia_BINARY_8DAY/2005/TEMP/'
            ; OUTPUT NAME PART 1
            OUTNAMEA = 'TUW_ASAGW_SSM_002_8DAY_'
            ; BUILD NAME
            OUTNAME = OUTNAMEA + OUTNAMEB + '_TO_' + OUTNAMEC + '.bin'
            ...
            OUTPATHOUTNAME = OUTPATH + OUTNAMEA + OUTNAMEB + OUTNAMEC + '.bin'
            ; SET FUNCTION 'FILEPATH'
            OUTFILE = FILEPATH(OUTNAME, ROOT_DIR='R:\', SUBDIRECTORY='ASAR_GM\ENVI_daily\Australia_BINARY_8DAY\2005\TEMP')
        ...
        PRINT,'GET FULL FILE NAME LIST'
        ; GET FILE NAMES
        ALLFILENAME2 = FILE_SEARCH("R:/ASAR_GM/ENVI_daily/Australia_BINARY_8DAY/2005/TEMP/", "*.bin", COUNT=COUNT)
        ;
        ; MANIPULATE FILE NAMES TO GET DATE
        ...
        WHILE (VA2 = VA2 + DA2) LE EA DO BEGIN
          ...
          PRINT,'  DATE LOOP: START'  
          ; RELATIONAL STATEMENT TO GET DATE RANGE
          INDEX = WHERE(((DMY3 LT VA2) AND (DMY3 GE DRS2)), COUNT)
          ; SET COUNT VARIABLE
          COUNTSPLIT = COUNT
          ; OUTPUT NAME PART 2 FILL NAME WITH DATE RANGE - PRECURSIVE TO PART 1
