...
PRO ASAR_GM_8DAY
  ...
  ;
  ; SETUP DATE LOOP
  SA = JULDAY(4, 15, 2005) ; (M,D,YYYY)
  DA = 8
  EA = JULDAY(1, 4, 2006) ; (M,D,YYYY)
  VA = SA
  ;
  ; DATE LOOP
  WHILE (VA = VA + DA) LE EA DO BEGIN
    ...
    ENDIF ELSE BEGIN
      ...
      FOR i=0, 20-1 DO BEGIN
        PRINT,''
        PRINT,'    MASTER ARRAY LOOP: START SPLIT MATRIX', i+1, ' OF 20'
        ; SET ARRAY COLUMN VALUE (71380580/20)=3569029
        COLVALUE = 3569029
        ...
        FOR k=0, COUNTSPLIT-1 DO BEGIN
          PRINT,'      FILL ARRAY LOOP: START FILE', k
          ...
          PRINT,'      FILL ARRAY LOOP: END FILE', k
        ENDFOR
        ; CALCULATE & WRITE
        PRINT,''
        ...
        FREE_LUN, UNIT
        PRINT,'    MASTER ARRAY LOOP: END; SPLIT MATRIX', i+1, ' OF 20'
      ENDFOR
