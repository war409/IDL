...
;        ROIs. *Updated to handle very large ROI.
; ######################################################################
;
PRO EXTRACT_RASTER_SUMMARY_BY_VECTOR_OWL_VERSION
  ...
  FNAME=["RASTERID","FILE&BAND","ROI","MEAN","STDDEV","MEDIAN","MIN","MAX","COUNT_255","COUNT_NOT_255","PRCT_EQ_255", $
    ...
    FOR j=0, N_ELEMENTS(POS)-1 DO BEGIN
      ...
      ENDIF ELSE BEGIN
        ...
        IF COUNT EQ 0 THEN BEGIN
          ...
          GRTCOUNT_ALL = TOTALCOUNT - COUNT
          NP1PROPx = (GRTCOUNT_ALL/TOTALCOUNT)
        ENDIF ELSE BEGIN
          ...
          ;
          TOTALCOUNT = (NO_NAN + NO_VALID)
          GRTCOUNT_ALL = TOTALCOUNT - COUNTD
          NP1PROPx = (GRTCOUNT_ALL/TOTALCOUNT)
        ENDELSE
      ENDELSE
      ;   
      ...
      ENDIF ELSE BEGIN
        ...
        IF COUNT EQ 0 THEN BEGIN
          ...
          TOTALCOUNT = (NO_NAN + NO_VALID)
          GRTCOUNT_ALL = TOTALCOUNT - COUNT
          NP2PROPx = (GRTCOUNT_ALL/TOTALCOUNT)
        ENDIF ELSE BEGIN
          ; IF VALUES LESS THAN THRESHOLD
          COUNTD = DOUBLE(COUNT)
          ;
      ...
      ENDIF ELSE BEGIN
        ...
        IF COUNT EQ 0 THEN BEGIN
          ...
          TOTALCOUNT = (NO_NAN + NO_VALID)
          GRTCOUNT_ALL = TOTALCOUNT - COUNT
          NP3PROPx = (GRTCOUNT_ALL/TOTALCOUNT)
        ENDIF ELSE BEGIN
          ; IF VALUES LESS THAN THRESHOLD
          COUNTD = DOUBLE(COUNT)
          ;
      ...
      ENDIF ELSE BEGIN
        ...
        IF COUNT EQ 0 THEN BEGIN
          ...
          TOTALCOUNT = (NO_NAN + NO_VALID)
          GRTCOUNT_ALL = TOTALCOUNT - COUNT
          NP4PROPx = (GRTCOUNT_ALL/TOTALCOUNT)
        ENDIF ELSE BEGIN
          ; IF VALUES LESS THAN THRESHOLD
          COUNTD = DOUBLE(COUNT)
          ;
      ...
      ENDIF ELSE BEGIN
        ...
        IF COUNT EQ 0 THEN BEGIN
          ...
          TOTALCOUNT = (NO_NAN + NO_VALID)
          GRTCOUNT_ALL = TOTALCOUNT - COUNT
          NP5PROPx = (GRTCOUNT_ALL/TOTALCOUNT)
        ENDIF ELSE BEGIN
          ; IF VALUES LESS THAN THRESHOLD
          COUNTD = DOUBLE(COUNT)
          ;
      ...
      ENDIF ELSE BEGIN
        ...
        IF COUNT EQ 0 THEN BEGIN
          ...
          TOTALCOUNT = (NO_NAN + NO_VALID)
          GRTCOUNT_ALL = TOTALCOUNT - COUNT
          NP6PROPx = (GRTCOUNT_ALL/TOTALCOUNT)
        ENDIF ELSE BEGIN
          ; IF VALUES LESS THAN THRESHOLD
          COUNTD = DOUBLE(COUNT)
          ;
      ...
      ENDIF ELSE BEGIN
        ...
        IF COUNT EQ 0 THEN BEGIN
          ...
          TOTALCOUNT = (NO_NAN + NO_VALID)
          GRTCOUNT_ALL = TOTALCOUNT - COUNT
          NP7PROPx = (GRTCOUNT_ALL/TOTALCOUNT)
        ENDIF ELSE BEGIN
          ; IF VALUES LESS THAN THRESHOLD
          COUNTD = DOUBLE(COUNT)
          ;
      ...
      ENDIF ELSE BEGIN
        ...
        IF COUNT EQ 0 THEN BEGIN
          ...
          TOTALCOUNT = (NO_NAN + NO_VALID)
          GRTCOUNT_ALL = TOTALCOUNT - COUNT
          NP8PROPx = (GRTCOUNT_ALL/TOTALCOUNT)
        ENDIF ELSE BEGIN
          ; IF VALUES LESS THAN THRESHOLD
          COUNTD = DOUBLE(COUNT)
          ;
      ...
      ENDIF ELSE BEGIN
        ...
        IF COUNT EQ 0 THEN BEGIN
          ...
          TOTALCOUNT = (NO_NAN + NO_VALID)
          GRTCOUNT_ALL = TOTALCOUNT - COUNT
          NP9PROPx = (GRTCOUNT_ALL/TOTALCOUNT)
        ENDIF ELSE BEGIN
          ; IF VALUES LESS THAN THRESHOLD
          COUNTD = DOUBLE(COUNT)
          ;
