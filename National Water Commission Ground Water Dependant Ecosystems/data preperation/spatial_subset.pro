...
PRO spatial_subset
  ...
  output_directory = DIALOG_PICKFILE(PATH='\\osm-08-mel.it.csiro.au\OSM_MEL_LW_RRMARCHIVE_archive\Users\war409\Projects\Fault_related_lineaments\Data\Out\', TITLE='Select The Output Folder', /DIRECTORY, /OVERWRITE_PROMPT)
  ...
  FOR i=0, N_ELEMENTS(filenames)-1 DO BEGIN ; Loop through each input file:
    ...
    output_filename = output_directory + name + '.dat' ; Build the output filename.
